...
<body>  
    <main class="flex flex-col items-center h-screen w-screen bg-green-200">
        <div class="flex flex-col items-center bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <img class="h-32 w-32" src="/PHP/images/wondervilleLogo.png" alt="Logo for Wonderville Parking">
            <?php
            ...
            ?>
            <a href="/PHP/index.php" class="w-26 text-center text-white bg-blue-500 hover:bg-blue-700 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none">
                Return To Home
            </a>
        </div>
    </main>
